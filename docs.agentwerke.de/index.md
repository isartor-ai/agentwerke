...
<div class="doc-map">
  <img src="/agentwerke-run-map.svg" alt="Map of an Agentwerke run from trigger to BPMN run, agent task, policy gate, tool call, approval, and evidence." />
</div>
...
<div class="manual-grid">
  ...
  <a href="/admin/deployment.html">
    <strong>Deploy Agentwerke</strong>
