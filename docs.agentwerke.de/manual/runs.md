...
A run is the operator's main unit of work in Agentwerke. It is one execution of a workflow, with its own context, steps, approvals, evidence, and audit trail.
