...
export default defineConfig({
  lang: 'en-US',
  title: 'Autofac',
  description: 'User manual for governed AI software delivery with Autofac.',
  base: '/',
  lastUpdated: true,
  themeConfig: {
    logo: '/autofac-run-map.svg',
    siteTitle: 'Autofac Docs',
    search: {
      provider: 'local',
    },
    nav: [
    ...
    sidebar: [
      {
        text: 'Start Here',
        items: [
          { text: 'What Autofac Is', link: '/start/what-is-autofac' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Extending Autofac', link: '/developer/extending-autofac' },
        ],
      },
      {
        text: 'Reference',
    ...
    editLink: {
      pattern: 'https://github.com/isartor-ai/autofac/edit/main/docs.autofac.de/:path',
      text: 'Edit this page on GitHub',
    },
    socialLinks: [
      { icon: 'github', link: 'https://github.com/isartor-ai/autofac' },
    ],
    footer: {
