...
Autofac is open core. The core platform is Apache-2.0 and self-hostable. A separately licensed commercial tier adds enterprise governance, scale, and operations features.
