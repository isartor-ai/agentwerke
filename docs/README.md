...
- [Brand migration](brand-migration.md) — Agentwerke rename and compatibility notes
...
## Decisions
- [ADR-002 — BPMN-centric Agentwerke runtime by default](decisions/ADR-002-use-bpmn-centric-autofac-runtime-by-default.md)
