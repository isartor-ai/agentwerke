...
ADR-001 selected Camunda 8 as the production BPMN runtime. The revised decision keeps Autofac BPMN-centric but makes the bounded Postgres-backed Autofac runtime the default runtime for MVP, pilots, and first self-hosted deployments.

## Scope

- Mark ADR-001 as superseded.
- Add ADR-002 documenting the default Autofac runtime and optional Camunda adapter policy.
...
- Architecture docs consistently describe the Autofac/Postgres runtime as the default.
