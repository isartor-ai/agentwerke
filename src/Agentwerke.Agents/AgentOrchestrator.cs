...
using Agentwerke.Agents.Security;
...
public sealed class AgentOrchestrator : IServiceTaskExecutor
{
    ...
    private readonly Agentwerke.Sandboxes.SandboxOptions _sandboxOptions;
    ...
    public AgentOrchestrator(
        ...
        IOptions<Agentwerke.Sandboxes.SandboxOptions> sandboxOptions,
    ...
    /// to <see cref="Agentwerke.Agents.Tools.CicdTriggerDeployTool"/> instead of running an agent.
    /// </summary>
