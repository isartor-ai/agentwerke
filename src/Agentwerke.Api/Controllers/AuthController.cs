...
public sealed class AuthController : ControllerBase
{
    ...
    public IActionResult GetAuthConfig()
    {
        ...
        return Ok(new
        {
            ...
            roles = new[] { AgentwerkeRoles.Viewer, AgentwerkeRoles.Operator, AgentwerkeRoles.Approver, AgentwerkeRoles.Admin }
        });
    }
    ...
    public IActionResult GetCurrentUser()
    {
        ...
        var roles = User.FindAll(ClaimTypes.Role)
            .Select(claim => AgentwerkeRoleMapper.CanonicalizeRole(claim.Value))
    ...
    public IActionResult IssueDevToken([FromBody] DevTokenRequest request)
    {
        ...
        var validRoles = new[] { AgentwerkeRoles.Viewer, AgentwerkeRoles.Operator, AgentwerkeRoles.Approver, AgentwerkeRoles.Admin };
