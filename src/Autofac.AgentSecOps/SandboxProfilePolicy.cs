...
///
/// Deliberately has no dependency on Autofac.Sandboxes: it reasons about profile *names*
/// (declared on the agent profile / requested by the workflow task), not the technical
/// resource/network/volume mapping, which lives in Autofac.Sandboxes.SandboxProfileCatalog.
/// </summary>
