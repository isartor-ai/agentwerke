...
namespace Autofac.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260617065901_AddCamundaDeploymentAndProcessInstanceMetadata")]
    partial class AddCamundaDeploymentAndProcessInstanceMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Autofac.Domain.Persistence.AuditRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Autofac.Domain.Persistence.RunContextEntry", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Autofac.Domain.Persistence.WorkflowDefinition", b =>
                {
                    ...
                    b.Property<string>("CamundaDeployedAt")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("CamundaDeploymentKey")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<string>("CamundaProcessDefinitionKey")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<int?>("CamundaProcessDefinitionVersion")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Autofac.Domain.Persistence.WorkflowRun", b =>
                {
                    ...
                    b.Property<string>("CamundaProcessInstanceKey")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("Autofac.Domain.Persistence.WorkflowRunStep", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
