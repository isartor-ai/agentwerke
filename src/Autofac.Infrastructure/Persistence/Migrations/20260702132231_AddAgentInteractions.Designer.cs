...
namespace Autofac.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260702132231_AddAgentInteractions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Autofac.Domain.Persistence.AgentInteraction", b =>
                {
                    ...
                    b.Property<string>("AddresseeType")
                        .IsRequired()
                        .HasMaxLength(32)
            ...
            modelBuilder.Entity("Autofac.Domain.Persistence.WaitingExternalCorrelation", b =>
                {
                    b.Property<string>("RunId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.OwnsOne("Autofac.Domain.Persistence.PolicyDecision", "PolicyDecision", b1 =>
                        {
                            ...
                            b1.Property<int>("PurposeConfidence")
                                .HasColumnType("integer");

                            b1.Property<string>("PurposeRationale")
                                .IsRequired()
                                .HasColumnType("text");
