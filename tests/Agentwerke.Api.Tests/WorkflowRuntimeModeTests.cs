...
public sealed class WorkflowRuntimeModeTests
{
    ...
    [Fact]
    public void AddAgentwerkeInfrastructure_DefaultMode_DoesNotWireCamundaClientsOrConfig()
    {
    ...
    [Fact]
    public void AddAgentwerkeInfrastructure_CamundaMode_WiresCamundaClient()
    {
    ...
    [Fact]
    public void AddAgentwerkeInfrastructure_RegistersFilePolicyRuleStore()
    {
